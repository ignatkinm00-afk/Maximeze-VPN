package com.maximeze-vpn.maximeze-vpn.bg
...
import com.maximeze-vpn.core.api.v2.config.Protocol
import com.maximeze-vpn.core.api.v2.hcommon.Empty
import com.maximeze-vpn.core.api.v2.hcore.CoreClient
import com.maximeze-vpn.core.api.v2.hcore.SystemInfo
import com.maximeze-vpn.core.api.v2.hello.HelloClient
import com.maximeze-vpn.core.api.v2.hello.HelloRequest
import com.maximeze-vpn.maximeze-vpn.Application
import com.maximeze-vpn.maximeze-vpn.MainActivity
import com.maximeze-vpn.maximeze-vpn.R
import com.maximeze-vpn.maximeze-vpn.Settings
import com.maximeze-vpn.maximeze-vpn.constant.Action
import com.maximeze-vpn.maximeze-vpn.constant.Status
//import com.maximeze-vpn.maximeze-vpn.utils.CommandClient
import com.maximeze-vpn.core.libbox.Libbox
import com.maximeze-vpn.maximeze-vpn.Application.Companion.notification
import com.maximeze-vpn.maximeze-vpn.utils.GrpcClientProvider
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Application.notification.createNotificationChannel(
                NotificationChannel(
                    notificationChannel, "maximeze-vpn service", NotificationManager.IMPORTANCE_LOW
                )
            )
        }
        service.startForeground(
            notificationId, notificationBuilder
                .setContentTitle(profileName.takeIf { it.isNotBlank() } ?: "Maximeze VPN")
