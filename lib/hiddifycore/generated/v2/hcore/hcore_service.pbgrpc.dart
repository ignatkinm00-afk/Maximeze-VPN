...
class CoreClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.CoreInfoResponse> changeMaximeze VPNSettings(
    $0.ChangeMaximeze VPNSettingsRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$changeMaximeze VPNSettings, request, options: options);
  }
  ...
  static final _$changeMaximeze VPNSettings =
      $grpc.ClientMethod<$0.ChangeMaximeze VPNSettingsRequest, $0.CoreInfoResponse>(
          '/hcore.Core/ChangeMaximeze VPNSettings',
          ($0.ChangeMaximeze VPNSettingsRequest value) => value.writeToBuffer(),
          $0.CoreInfoResponse.fromBuffer);
...
abstract class CoreServiceBase extends $grpc.Service {
  ...
  CoreServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ChangeMaximeze VPNSettingsRequest,
            $0.CoreInfoResponse>(
        'ChangeMaximeze VPNSettings',
        changeMaximeze VPNSettings_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ChangeMaximeze VPNSettingsRequest.fromBuffer(value),
        ($0.CoreInfoResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.StartRequest, $0.CoreInfoResponse>(
        'StartService',
        startService_Pre,
  ...
  $async.Future<$0.CoreInfoResponse> changeMaximeze VPNSettings_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.ChangeMaximeze VPNSettingsRequest> $request) async {
    return changeMaximeze VPNSettings($call, await $request);
  }

  $async.Future<$0.CoreInfoResponse> changeMaximeze VPNSettings(
      $grpc.ServiceCall call, $0.ChangeMaximeze VPNSettingsRequest request);
