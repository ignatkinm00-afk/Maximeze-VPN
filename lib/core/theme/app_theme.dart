...
import 'package:maximeze_vpn/core/theme/app_theme_mode.dart';
...
class AppTheme {
  ...
  // Brand colors: blue #2979FF, purple #7B2FFF
  static const Color brandBlue = Color(0xFF2979FF);
  static const Color brandPurple = Color(0xFF7B2FFF);

  ThemeData lightTheme(ColorScheme? lightColorScheme) {
    final ColorScheme scheme = lightColorScheme ?? ColorScheme.fromSeed(seedColor: brandBlue);
    return ThemeData(
      useMaterial3: true,
      colorScheme: scheme.copyWith(primary: brandBlue, secondary: brandPurple),
  ...
  ThemeData darkTheme(ColorScheme? darkColorScheme) {
    final ColorScheme scheme =
        darkColorScheme ?? ColorScheme.fromSeed(seedColor: brandBlue, brightness: Brightness.dark);
    return ThemeData(
      useMaterial3: true,
      colorScheme: scheme.copyWith(primary: brandBlue, secondary: brandPurple),
